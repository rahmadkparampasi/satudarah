        ...
        var button = ui.buttonGroup([
          ...
          ui.dropdown({
            ...
            click: function (e) {
              ...
              $('.note-editing-area').removeClass('a0').removeClass('a1').removeClass('a2').removeClass('a3').removeClass('a4').removeClass('a5').removeClass('legal');
              switch (value){
                case 'A0':
                ...
                case 'LEGAL':
                  ...
                  $('.note-editable').css({'width':'793px'}); // height:595
                break;
                default:
                 $('.note-frame').removeClass('note-document');
                 $('.note-editing-area').removeClass('a0').removeClass('a1').removeClass('a2').removeClass('a3').removeClass('a4').removeClass('a5').removeClass('legal');
