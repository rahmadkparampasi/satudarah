<div id="modalAddDnr" class="modal" tabindex="-1" role="dialog" aria-labelledby="modalAddDnrTitle" aria-modal="true">
    <div class="modal-dialog modal-lg" role="document">
        <form id="modalAddDnrF" method="POST" action="{{route('dnrm.insertK')}}" enctype="multipart/form-data" data-load="true">
            @csrf
            <input type="hidden" id="dnrm_id" name="dnrm_id" value="" />
            <input type="hidden" id="dnrm_dnr" name="dnrm_dnr" value="{{$Dnrk->dnr_id}}" />
